      ...
      <div className="about-grid">
        <section className="about-left info">
          ...
          <h3 className='section-title'>
            Opportunities to achieve solidatiry and
            <span> long-term connections. </span>
          </h3>
          <div className="section-resume">
            <p>
              After overcoming life-threatening illness, she dedicated years to
              uncovering solutions that empower everyone to live healthier
              lives.
            </p>
          </div>
